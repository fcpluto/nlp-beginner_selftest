...
class LrConfig(object):
    ...
    # if not os.path.exists(os.path.join(pwd_path + '/model' + "/checkpoints")):
    #     os.makedirs(os.path.join(pwd_path + '/model' + "/checkpoints"))
    lr_save_dir = os.path.join(pwd_path + '/model' + "/checkpoints")

    # if not os.path.exists(os.path.join(lr_save_dir, '/best_validation')):
    #     os.makedirs(os.path.join(lr_save_dir, 'best_validation'))
